              ...
              <div class="card-body p-md-5" style="background-color: white;">
                <div class="row justify-content-center">
                  <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                    <ul class="list-group">
                        <li class="rounded-pill" style="background-color: white; text-align: center; list-style: none; "><img src="img/logo/التعليم.jpg" class="rounded" width="200px" height="200px"></li>
                        <li class="rounded-pill" style="background-color: white; text-align: center; list-style: none; ">
                        <li class="rounded-pill" style="background-color: lightskyblue; text-align: center; list-style: none; ">المكتبة الرقمية السعودية توقع مع 9 قواعد علمية عالمية وتوفرها مباشرة للباحثين</li>
                        <br>
                        <li class="rounded-pill" style="background-color: lightskyblue; text-align: center; list-style: none; ">وزارة التعليم  : <br>
                            بالتعاون مع وزارة التعليم.. انطلاق المرحلة الأولى من برنامج اكتشاف المواهب</li>
                        <br>
                        <li class="rounded-pill" style="background-color: lightskyblue; text-align: center; list-style: none; "><br>
                            soon
                        <br></li>
                        <br>
                        <li class="rounded-pill" style="background-color: lightskyblue; text-align: center; list-style: none; "><br>
