...
<body >
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <section class="vh-100" style="background-color: rgb(255, 255, 255);">
        ...
        <!--محتوى الاخبار-->
                      <h1 style="color: white;">  حالة الطقس في الرياض </h1>
                      <br>
                        <p style="color: white;">
                            يشعر كأنه:
                            23 °C
