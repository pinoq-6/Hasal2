...
<body >
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <section class="vh-100" style="background-color: rgb(255, 255, 255);">
        ...
        <!--محتوى الاخبار-->
                      <h1 style="color: white;">“الصحة”: تحدد مدة القيلولة المسموح بها وتوقيتها المناسب
                    </h1>
                      <br>
                        <p style="color: white;">
                            حددت وزارة الصحة، مدة القيلولة المسموح بها وتوقيتها المناسب بعد موعد الاستيقاظ اليومي


                            وأوضحت وزارة الصحة أهمية وقت القيلولة للجسم ومدتها المناسبة وتوقيتها بعد موعد الاستيقاظ اليومي.						</p>
                        <br>
                        <p style="color: white;">
                            وأضافت الوزارة عبر "عش بصحة"، أن القيلولة تساعد على النشاط لفترة أطول في يومك، بشرط ألا تتجاوز 20 - 30 دقيقة بعد استيقاظك بـ 6 ساعات تقريباً.
                    ...
                    <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                       <!--صوره للمحتوى-->
                      <img src="https://www.alweeam.com.sa/wp-content/uploads/2022/01/23444.jpg"
