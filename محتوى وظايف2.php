...
<body >
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <section class="vh-100" style="background-color: rgb(255, 255, 255);">
        ...
        <!--محتوى الاخبار-->
                      <h1 style="color: white;">  وظائف أصحاب العمل من وظيفة.كوم		  </h1>
                      <br>
                        <p style="color: white;">
                            اخصائي تقنية هندسة شبكات	متاحة للجميع - رجال	مكة المكرمة - منطقة مكة	/الموقع وظايف كوم
						</p>
                        <br>
                        <p style="color: white;">
                            Waste Management Consultant	متاحة للجميع - رجال	جدة - منطقة مكة/وظايف كوم
						</p>
                        <p style="color: white;">
                            HSE Consulant	متاحة للجميع - رجال	جدة - منطقة مكة
						</p>                           
                        <p style="color: white;"> 
                            industrial Hygien Consultant	متاحة للجميع - رجال	جدة - منطقة مكة/وظايف كوم				</p>
                        <p style="color: white;">
                            Environment Sustainability ...	متاحة للجميع - رجال	جدة - منطقة مكة/وظايف كوم					</p>
                        <p style="color: white;">
                            Safety & Fire Protection Co...	متاحة للجميع - رجال	جدة - منطقة مكة/وظايف كوم
                    ...
                    <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                       <!--صوره للمحتوى-->
                      <img src="https://www.wadhefa.com/images/logo_nt3_250x250.png"
