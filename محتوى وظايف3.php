...
<body >
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <section class="vh-100" style="background-color: rgb(255, 255, 255);">
        ...
        <!--محتوى الاخبار-->
                      <h1 style="color: white;">  الهيئة الملكية في العلا تعلن عن بدء ملتقى التوظيف لجميع المؤهلات والتخصصات  </h1>
                      <br>
                        <p style="color: white;">
                            الهيئة الملكية في محافظة العلا، تعلن عن فتح باب التقديم على طلبات التوظيف عبر (ملتقى العلا للتوظيف)،  لتوفير الفرص وظيفية لأبناء وبنات الوطن، وذلك بالشراكة مع صندوق تنمية الموارد البشرية (هدف) وكبرى شركات القطاع الخاص،
						</p>
                        <br>
                        <p style="color: white;">
                            المؤهلات:
                            – (الابتدائية، المتوسط، الثانوي، الدبلوم، البكالوريوس، الماجستير).
						</p>
                        <p style="color: white;">
                            التخصصات:
                            – التقديم متاح لجميع التخصصات.
						</p>                           
                        <p style="color: white;"> 
                            الخبرات:
                        ...
                        <p style="color: white;">
                            اهداف الملتقى:
                            توفير الفرص الوظيفية لأبناء وبنات الوطن في محافظة العلا. 
                             تعزيز التنمية الاقتصادية والاجتماعية.
                            رفع معدلات توظيف الكوادر الوطنية.				</p>
                        <p style="color: white;">
                            – يبدأ الملتقى: يوم الثلاثاء 1444/02/17هـ
– ينتهي الملتقى: يوم الخميس 1444/02/19هـ
– الموقع الملتقى: معهد العلا للغات.

-كما ان التسجيل متاح الآن عبر الرابط التالي:

رابط التقديم: urly.it/3pys_
						</p>                         
                    ...
                    <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                       <!--صوره للمحتوى-->
                      <img src="https://wadhefaksa.com/wp-content/uploads/2022/08/262d7337397a-390x220.png"
