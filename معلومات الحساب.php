        ...
        <div class="container py-5 h-100">
          <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="col col-lg-9 col-xl-7">
              <div class="card">
                <div class="rounded-top text-white d-flex flex-row" style="background-color: lightskyblue; height:200px;">
                ...
                <div class="card-body p-4 text-black">
                  <div class="mb-5">
                    ...
                    <div class="p-4" style="background-color: #f8f9fa;">
                      ...
                      <p class="font-italic mb-1">Lives in Riyadh</p>
                      <p class="font-italic mb-0">Student in ksu</p>
                    </div>
                  </div>
                  <div class="d-flex justify-content-between align-items-center mb-4">
                    <p class="lead fw-normal mb-0">News intrested in</p>
                  </div>
                  <div class="row g-2">
                    <div class="col mb-2">
                        <li class="rounded-pill" style="background-color: white; text-align: center; list-style: none; "><a href="محتوى اخبار4.php"><img src="https://www.okaz.com.sa/uploads/images/2021/11/08/1889150.jpg" class="rounded" width="400px" height="200px"></li></a>
                    </div>
                    <div class="col mb-2">
                      <li class="rounded-pill" style="background-color: white; text-align: center; list-style: none; "><a href="محتوى اخبار.php"><img src="file:///C:/Users/SiRrO/OneDrive/%D8%B3%D8%B7%D8%AD%20%D8%A7%D9%84%D9%85%D9%83%D8%AA%D8%A8/1%D9%85%D8%B4%D8%B1%D9%88%D8%B9%20%D8%AA%D8%AE%D8%B1%D8%AC/img/logo/%D8%B4%D9%88%D9%8A%D8%BA%D9%88.png" class="w-100 rounded-3"></li></a>
                    </div>
                  </div>
                  <div class="row g-2">
                    <div class="col">
                        <li class="rounded-pill" style="background-color: white; text-align: center; list-style: none; "><a href="محتوى اخبار6.php"><img src="https://www.okaz.com.sa/uploads/images/2023/09/23/2158404.jpg" class="w-100 rounded-3"></li></a>
                    </div>
                    <div class="col">
                      <li class="rounded-pill" style="background-color: white; text-align: center; list-style: none; "><a href="محتوى اخبار2.php"><img src="https://www.okaz.com.sa/uploads/images/2023/04/17/2102502.jpg" class="w-100 rounded-3"></li></a>
