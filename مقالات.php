...
include './inc/db.php';
include './inc/form7.php';
$sql_s = 'SELECT * FROM مقالات';
                  ...
                  <div class="col-md-10 col-lg-7 col-xl-7 order-2 order-lg-1">
                    <ul class="list-group">
                      <div class="list-group">
                        <a href="محتوى مقالات1.php" class="list-group-item list-group-item-action" style="background-color: skyblue">
                          <div class="d-flex w-100 justify-content-between">
                            <!--اكتب رأس قلم الخبر في السطر التالي في مكان (List group item heading)-->
                            <h5 class="mb-1">اليوم الوطني السعودي 89
                            </h5>
                            <!--اكتب متى تم عرض الخبر-->
                            <small class="text-muted">1 year ago</small>
                          </div>
                                  <!--اكتب في السطر التالي نبذه عن الخبر -->
                          <p class="mb-1">اليوم الوطنى هو يوم يحتفل بة الناس حبا و تقديرا للوطن الذى خيراتة علينا جميعا
                  
                            <br><img src="https://palsawa.com/uploads/images/BSFpj.jpg" class="rounded" width="350px" height="100px"></p></p>
                          <!--اكتب مصدر الخبر-->
                        ...
                        <a href="محتوى مقالات 2.php" class="list-group-item list-group-item-action" style="background-color: skyblue">
                          ...
                          <p class="mb-1">مواصفات الدولار الأسود الحقيقي، من أهم الموضوعات الحيوية التي تشغل بال الكثير من الأشخاص في هذه الفترة، وذلك لما للدولار من قيمة كبيرة في الأسواق المالية العالمية.
                            ...
                            <br><img src="img/logo/66666.jpeg" class="rounded" width="350px" height="100px"></p></p>
                          <!--اكتب مصدر الخبر-->
                          <small class="text-muted">CNN Arabic</small>
                        </a>
                        <br>
                        <a href="محتوى مقالات3.php" class="list-group-item list-group-item-action" style="background-color: skyblue">
                          <div class="d-flex w-100 justify-content-between">
                            <!--اكتب رأس قلم الخبر في السطر التالي في مكان (List group item heading)-->
                            <h5 class="mb-1">مواصفات الدولار الأسود الحقيقي
                            </h5>
                          ...
                          <p class="mb-1">مواصفات الدولار الأسود الحقيقي، من أهم الموضوعات الحيوية التي تشغل بال الكثير من الأشخاص في هذه الفترة، وذلك لما للدولار من قيمة كبيرة في الأسواق المالية العالمية.
                            ...
                            <br><img src="img/logo/مقلات4.jpeg" class="rounded" width="350px" height="100px"></p></p>
                          <!--اكتب مصدر الخبر-->
                          <small class="text-muted">SkyNews</small>
                        </a>
                        <br>
                        <a href="محتوى مقالات4.php" class="list-group-item list-group-item-action" style="background-color: skyblue">
                          <div class="d-flex w-100 justify-content-between">
                            <!--اكتب رأس قلم الخبر في السطر التالي في مكان (List group item heading)-->
                            <h5 class="mb-1">مواصفات الدولار الأسود الحقيقي
                            </h5>
                          ...
                          <p class="mb-1">مواصفات الدولار الأسود الحقيقي، من أهم الموضوعات الحيوية التي تشغل بال الكثير من الأشخاص في هذه الفترة، وذلك لما للدولار من قيمة كبيرة في الأسواق المالية العالمية.
                            ...
                            <br><img src="img/logo/مقلات3.jpeg" class="rounded" width="350px" height="100px"></p></p>
                          <!--اكتب مصدر الخبر-->
                          <small class="text-muted">SkyNews</small>
                        </a>
                        <br>
                        <a href="محتوى مقالات5.php" class="list-group-item list-group-item-action" style="background-color: skyblue">
                          ...
                          <p class="mb-1">مواصفات الدولار الأسود الحقيقي، من أهم الموضوعات الحيوية التي تشغل بال الكثير من الأشخاص في هذه الفترة، وذلك لما للدولار من قيمة كبيرة في الأسواق المالية العالمية.
                            ...
                            <br><img src="img/logo/مقلات5.jpeg" class="rounded" width="350px" height="100px"></p></p>
                          <!--اكتب مصدر الخبر-->
                ...
                <div class="col-md-10 col-lg-7 col-xl-7 order-2 order-lg-1">
                  <ul class="list-group">
                    <div class="list-group" style="background-color: white;">
                      <a href="https://twitter.com/stc_ksa/status/1236252814604730368" class="list-group-item list-group-item-action"  >
                        <div class="d-flex w-100 justify-content-between">
                        </div>
                        <p class="mb-1">          <br>      <img src="https://pbs.twimg.com/media/ESgNYhqX0AAKdrI.jpg" class="rounded" width="580px" height="400px"></p>
                        <small>اعلان</small>
                      </a>
      ...
      <div class="row d-flex justify-content-center align-items-center h-100">
        ...
        <div class="comments__container center__display">
             <div class="comment__card">
                    ...
                    <form action = "مقالات.php" method = "POST">
